...
- **How can I test out the [data fabric](#data-fabric-currently-in-public-preview-phase)?** If you would like to get access, you can request it from the [product page](https://store.veracity.com/8ad08065-7fa8-475f-9055-83067132c022). We continue to work with leading customers and providers to verify the design and functionality of these elements of the platform, and explore how value can be best created for asset owners and analytic providers. 
