...
# Sensor data
Veracity supports both high frequent stream and batch of sensor data. Data is made available for consumers using rest api or Azure Event hubs.

## Metadata
The meta-data for sensors are based on the ISO 19848 model of data-channels.
