...
Every variant has a name and a description.​
When naming a specific variant, please try to be short and to the point in what the user gets. The description below the name of the variant should help in specifying what it`s included in this package. ​The pricing models rows should be kept simple, and differentiate mainly by:​
* Prices ​
...
* A name that is short and self-explanatory;​
* Different prices and subscription type;​
* A brief explanation at the top (we recommend this to be short, as features area should already cover most of the added value for your product)
* Features and usage 
​
